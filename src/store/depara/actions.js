...
export default {
  ...
  gerarGradeDownload(context, produtos) {
    ...
    webservice
      .post(`v2/depara/carga/grades/download`, { produtos: produtos })
      .then(response => {
  ...
  gerarCombinacaoDownload(context, produtos) {
    ...
    webservice.defaults.responseType = "arraybuffer";
    webservice
      .post(`v2/depara/carga/artigos/download`, { produtos: produtos })
      .then(response => {
        context.dispatch("download", response);
      })
      .catch(error => {
  ...
  gerarFTDownload(context, produtos) {
    ...
    webservice.defaults.responseType = "arraybuffer";
    webservice
      .post(`v2/depara/carga/ft/download`, { produtos: produtos })
      .then(response => {
        context.dispatch("download", response);
      })
      .catch(error => {
  ...
  gerarGrade(context, produtos) {
    ...
    return new Promise((resolve, reject) => {
      webservice
        .post(`v2/depara/carga/grades`, { produtos: produtos })
        .then(response => {
  ...
  gerarCombinacao(context, produtos) {
    ...
    return new Promise((resolve, reject) => {
      webservice
        .post(`v2/depara/carga/artigos`, { produtos: produtos })
        .then(response => {
  ...
  gerarFT(context, produtos) {
    ...
    return new Promise((resolve, reject) => {
      webservice
        .post(`v2/depara/carga/ft`, { produtos: produtos })
        .then(response => {
