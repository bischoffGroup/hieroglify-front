...
import {
  ...
  STORE_MAIN_FROM_MODULE, STORE_MAIN_IMPORTABLE_MODULE, STORE_MAIN_REPORT_MODULE, STORE_MAIN_SYSTEM_MODULE
} from '@/store/StoreNamesEnum';
import {
  storeCoreAuthModule,
  storeCoreNotificationsModule,
  storeCorePreloaderModule,
  storeMainFromModule, storeMainImportModule, storeMainReportModule, storeMainSystemModule
} from '@/store/config';

Vue.use(Vuex);
export const store = () => new Vuex.Store({
  modules: {
    [STORE_MAIN_IMPORTABLE_MODULE]: { ...storeMainImportModule },
    [STORE_MAIN_FROM_MODULE]: { ...storeMainFromModule },
    [STORE_MAIN_REPORT_MODULE]: { ...storeMainReportModule },
